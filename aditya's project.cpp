...
public:
	...
	void show_account() const;	// to show data on screen
	...
	void report() const;	// to show data in tabular format
	int retacno() const;	// to return account number
	int retdeposit() const;	// to return balance amount
	char rettype() const;	// to return type of account
};         
...
void delete_account(int n)
{
	...
	outFile.open("bank1.txt",ios::binary);
